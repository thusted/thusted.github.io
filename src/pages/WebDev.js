    ...
    <div>
      ...
      <div className="container">
        <div className="section">
          <Project href="#modal15" id="modal15" className="col s12 m4 l4" imgSrc={Advotecate} title="AdVOTEcate" description="is your advocate to your voting needs! Our app shows users how to register to vote, where the nearest polls are, sends text reminders near voting dates, and provides information of how to vote by mail.s" modalDescription="AdVOTEcate is your advocate to your voting needs! Our app shows users how to register to vote, where the nearest polls are, sends text reminders near voting dates, and provides information of how to vote by mail." imageArray={advotecateImages} tech={["Javascript", "React", "Express", "Axios", "Node", "MongoDB", "Material UI", "Google Maps API", "Passport", "Quick Easy SMS API", "HTML", "CSS"]} links={["https://advotecate.herokuapp.com/", "https://github.com/thusted/adVOTEcate", "https://www.youtube.com/watch?v=7EO6hS_wm4g"]}/>

          <Project href="#modal3" id="modal3" className="col s12" imgSrc={EmployeeDirectory} title="Employee Directory" description="is an application that creates a directory of employees with React." modalDescription="Employee Directory creates an employee directory with React. Users are able to filter employees by typing in names as well as sort employees alphabetically by name, country, or email." imageArray={[EmployeeDirectory]} tech={["React", "JavaScript", "HTML", "CSS"]} links={["https://ancient-thicket-95619.herokuapp.com/", "https://github.com/thusted/Employee_Directory"]}/>
          <br/>
